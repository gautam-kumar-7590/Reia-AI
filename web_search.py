...
# ─── TAVILY SEARCH TOOL ───────────────────────────────────────────────────────
# CORRECT
_TAVILY_KEY = os.getenv("TAVILY_API_KEY", "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")

def get_search_tool():
    # Set key in env so TavilySearchResults picks it up automatically
